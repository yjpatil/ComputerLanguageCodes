% ----------------------------------------------------------------------- %
% This code tries to understand the code to draw the 3D model of the subject
% ----------------------------------------------------------------------- %
...
% % ======================== Head ================================== % %
L1 = 2;
Head = translate(scale(sph,L1/2, L1/2, L1/1.4),0,0,L1+4.5); % scale - changes the shapes as you change the scaling parameters,translate - add bias to adjust to given axis 
Head.facecolor = [0.7 0.7 0.76];%[0.9 0.6 0.6];
%---------------------------------------------------------
...
%---------------------------------------------------------
Head = combine(Head,Neck,meys1,meys2); % Function "combine" tries to bring 
%Head = combine(meys1,meys2);
% % ======================== Shoulder =============================== % %
r2 = 1.2;
L2 = 3;
...
% % ************************* XXXXXX ********************************* % %
Body = combine(Head,Shoulder,Fore_Arm_left,Fore_Arm_right,Chest,Waist,Hip,Upper_Leg_left,Upper_Leg_right,Lower_Leg_left,Lower_Leg_right);
% % ************************* XXXXXX ********************************* % %
...
axis off
drawnow
set(gca,'xlim',[-7 7],'ylim',[-7 7],'zlim',[-7 7]);
