...
max_iters     = 45; %% Use 45 at max                                       % maximum number of EM iterations
min_iters     = 12;                                        % minimum number of EM iterations
...
for iter=1:max_iters; % EM loops
    ...
    if dia>2;figure(FigNum);showMoFAImages(MoFA,nHeight,nWidth);end;
end
