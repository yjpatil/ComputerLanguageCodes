...
LV = 4;FigNum = 1111;
[LogLMeet,ModelMeet]=BTPCA(Tr01(:,:,1:14),LV,MiXComp,RunTransInv,ShowImg);

% Scenario # 2 %
% Number of Latent Variables %
LV = 4;FigNum = 2222;
[LogLWatch,ModelWatch]=BTPCA(Tr02(:,:,1:14),LV,MiXComp,RunTransInv,ShowImg);

% Scenario # 3 %
% Number of Latent Variables %
LV = 4;FigNum = 3333;
[LogLPPT,ModelPPT]=BTPCA(Tr03(:,:,1:14),LV,MiXComp,RunTransInv,ShowImg);

% Scenario # 0302 %
% Number of Latent Variables %
LV = 4;FigNum = 3302;
[LogLPPT02,ModelPPT02]=BTPCA(Tr0302(:,:,1:14),LV,MiXComp,RunTransInv,ShowImg);
