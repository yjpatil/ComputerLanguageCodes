function[CSTr0101,CSTr0102,CSTr0103,CSTr0201,CSTr0202,CSTr0301] = fComSenCreateTrData03(LDPC,Tr0101,Tr0102,Tr0103,Tr0201,Tr0202,Tr0301)
...
for i = 1 : 1 : l
    TempMat = Tr0202(:,:,i);   
    CSTr0202(:,1,i) = mod(LDPC*TempMat,2);
end
