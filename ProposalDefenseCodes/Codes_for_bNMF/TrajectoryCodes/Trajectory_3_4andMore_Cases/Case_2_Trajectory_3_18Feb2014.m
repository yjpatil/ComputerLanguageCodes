...
s11 = [18.5,18.5,-135];%[X,Y,Angle w.r.t X]   % <>-------- Enter the Starting Point for 1st subject
...
while (s11(1) > 0.0000001 && s11(1) < 19.99995 && s11(2) > 0.000001 && s11(2) < 19.9999995)
    ...
    if (rem(i,SampleData)==0) % Plot if 'ith' iteration and SamplePlt value have 1 e.g (rem(11,10) = 1)
        ...
        elseif(XCoG1 >= 19.5 && YCoG1 >= 19.5 ) % ......... (2) ......... %
            s11(3) = -135;%s11(3) = s11(3) - 270;
            [X1,Y1,XCoG1,YCoG1] = computecarpoints01(s11(1), s11(2), s11(3),'r',carL,carW,0);
            WalkCount1 = WalkCount1 + 1;
...
T3C2_Loc1 = Location1;T3C2_Loc2 = Location2;
T3C2_Dir1 = Direction1;T3C2_Dir2 = Direction2;
T3C2_Hist1 = Hist1;T3C2_Hist2 = Hist2;

clearvars -except T3C2_Loc1 T3C2_Loc2 T3C2_Dir1 T3C2_Dir2 T3C2_Hist1 T3C2_Hist2
