...
StopSign = 43;  % <>----- "Important:: How many times you want the Target to bump at the end and take reverse turn"
...
hold on;
% % %
s22 = [18.5,1.5,135];%[X,Y,Angle w.r.t X]  % <>-------- Enter the Starting Point for 2nd subject
...
T3C3_Loc1 = Location1;T3C3_Loc2 = Location2;
T3C3_Dir1 = Direction1;T3C3_Dir2 = Direction2;
T3C3_Hist1 = Hist1;T3C3_Hist2 = Hist2;

clearvars -except T3C3_Loc1 T3C3_Loc2 T3C3_Dir1 T3C3_Dir2 T3C3_Hist1 T3C3_Hist2
