...
StopSign = 37;  % <>----- "Important:: How many times you want the Target to bump at the end and take reverse turn"

carL = 1.2;
carW = 1.3;

% % ----- Initial assignment of the position of the subject ----- % %
s11 = [1.5,18.5,-55];%[X,Y,Angle w.r.t X]   % <>-------- Enter the Starting Point for 1st subject
computecarpoints(s11(1),s11(2),s11(3),'r',carL,carW);
hold on;
% % %
s22 = [19,1,125];%[X,Y,Angle w.r.t X]  % <>-------- Enter the Starting Point for 2nd subject
...
T4C3_Loc1 = Location1;T4C3_Loc2 = Location2;
T4C3_Dir1 = Direction1;T4C3_Dir2 = Direction2;
T4C3_Hist1 = Hist1;T4C3_Hist2 = Hist2;

clearvars -except T4C3_Loc1 T4C3_Loc2 T4C3_Dir1 T4C3_Dir2 T4C3_Hist1 T4C3_Hist2
