...
s11 = [12.5,1.5,90];%[X,Y,Angle w.r.t X]   % <>-------- Enter the Starting Point for 1st subject
computecarpoints(s11(1),s11(2),s11(3),'r',carL,carW);
hold on;
s22 = [1.5,7.5,0];%[X,Y,Angle w.r.t X]  % <>-------- Enter the Starting Point for 2nd subject
...
while (s22(1) > 0.0000001 && s22(1) < 19.99999995 && s22(2) > 0.0000001 && s22(2) < 19.9999995)
    ...
    if (rem(i,SampleData)==0)    
        ...
        CodeRec2(it2,:) = Code2';
        it2 = it2 + 1;
        if(XCoG2 <= 1.5 && YCoG2 <= 10 )
            s22(3) = 0;
            [X2,Y2,XCoG2,YCoG2]=computecarpoints01(s22(1), s22(2), s22(3),'c',carL,carW,0);
            WalkCount2 = WalkCount2 + 1;
        elseif(XCoG2 >= 18.5 && YCoG2 <= 10 )
            s22(3) = 180;
            [X2,Y2,XCoG2,YCoG2]=computecarpoints01(s22(1), s22(2), s22(3),'c',carL,carW,0);
            WalkCount2 = WalkCount2 + 1;
...
Rev_T1C3_Loc1 = Location1;Rev_T1C3_Loc2 = Location2;
Rev_T1C3_Dir1 = Direction1;Rev_T1C3_Dir2 = Direction2;
Rev_T1C3_Hist1 = Hist1;Rev_T1C3_Hist2 = Hist2;

clearvars -except Rev_T1C3_Loc1 Rev_T1C3_Loc2 Rev_T1C3_Dir1 Rev_T1C3_Dir2 Rev_T1C3_Hist1 Rev_T1C3_Hist2
