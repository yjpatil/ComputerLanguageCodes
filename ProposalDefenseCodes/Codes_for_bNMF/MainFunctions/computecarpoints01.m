function [x_points,y_points,XCoG,YCoG] = computecarpoints01(x0,y0,angle,Color,carL,carW,Plot)
gcf;
...
if(Plot)
    plot(XCoG,YCoG,'ok','Linewidth',1.5);
    %plot([Xm1m2 Xm3m4],[Ym1m2 Ym3m4], '-k','Linewidth',1.5);
    %plot([Xm2m3 Xm1m4],[Ym2m3 Ym1m4], Color,'Linewidth',1.5);
    plot([XCoG Xm2m3],[YCoG Ym2m3], Color,'Linewidth',1.5); % % **This is the part where you plot the nose/front end of the 
end
