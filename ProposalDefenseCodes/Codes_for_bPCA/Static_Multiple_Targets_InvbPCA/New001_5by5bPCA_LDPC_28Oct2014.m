% ----------------------------------------------------------------------- %
%               Code for Journal Paper for Scenario Recognition           %
% ----------------------------------------------------------------------- %
clc;clear all;close all;

% ----------- Initialization -------------- %
addpath('C:\Users\Yuri\Dropbox\Walker_Coding\ProposalDefenseCodes\Codes_for_bPCA\Main_Functions\');
addpath('C:\Users\student\Dropbox\Walker_Coding\ProposalDefenseCodes\Codes_for_bPCA\Main_Functions\');
