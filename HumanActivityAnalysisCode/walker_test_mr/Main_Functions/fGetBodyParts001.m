function[Head,Shoulder,Upper_Arm_left,Upper_Arm_right,Fore_Arm_left,Fore_Arm_right,Chest,Waist,Hip,Upper_Leg_left,Upper_Leg_right,Lower_Leg_left,Lower_Leg_right,L2,L3,L7,L71,L72] = fGetBodyParts001(FaceColor)
%
...
Shoulder.facecolor = [1.0 1.0 1.0];%Shoulder.facecolor = [0.9 0.6 0.6];
Shoulder1.facecolor = [0.6 0.6 0.6];%Shoulder1.facecolor = [0.9 0.6 0.6];
Shoulder2.facecolor = [0.6 0.6 0.6];%Shoulder2.facecolor = [0.9 0.6 0.6];
%---------------------------------------------------------
...
Upper_Arm_left.facecolor = [1.0 1.0 1.0];%Upper_Arm_left.facecolor = [0.9 0.6 0.6];

% % ======================= Right Upper Arm ========================== % %
%Upper_Arm_right = translate(scale(cyl,r3/2,r3/2,L3/2),0,0,-L3/2);
Upper_Arm_right = translate(scale(sph,r3/2,r3/2,L3/1.6),0,0,-L3/2);
Upper_Arm_right.facecolor = [1.0 1.0 1.0];%Upper_Arm_right.facecolor = [0.9 0.6 0.6];
...
Fore_Arm_left.facecolor = [1.0 1.0 1.0];%Fore_Arm_left.facecolor = [0.9 0.6 0.6];
...
Fore_Arm_right.facecolor = [1.0 1.0 1.0];%Fore_Arm_right.facecolor = [0.9 0.6 0.6];
...
Chest.facecolor = [1.0 1.0 1.0];%Chest.facecolor = [0.9 0.6 0.6];

% % ====================== Waist + Waist joint ======================== % %
r5 = 1;
L5 = 2;
Waist = translate(scale(cyl,r5/2,r5/2,L5/2),0, 0, 5-L4-L5/2);
Waist.facecolor = [1.0 1.0 1.0];%Waist.facecolor = [0.9 0.6 0.6];

sph_hf2 = UnitSphere_half(2,0.4);
Waistd = rotateY(scale(sph_hf2,L1/2, L1/2, L1/0.5),180);
Waistd = translate(Waistd,0,0,4.7);
Waistd.facecolor = [1.0 1.0 1.0];%Waistd.facecolor = [0.9 0.6 0.6];
...
Hipd.facecolor = [1.0 1.0 1.0];%Hipd.facecolor = [0.9 0.6 0.6];

Hipd2 = rotateY(scale(sph_hf3,L1/2, L1/2, L1/0.5),180);
Hipd2 = translate(Hipd2,0,0,3.2);
Hipd2.facecolor = [1.0 1.0 1.0];%Hipd2.facecolor = [0.9 0.6 0.6];

Shoulder_d1 = translate(scale(sph,L1/5, L1/5, L1/5),0,-0.7,0.2);
Shoulder_d2 = translate(scale(sph,L1/5, L1/5, L1/5),0,0.7,0.2);
Shoulder_d1.facecolor = [1.0 1.0 1.0];%Shoulder_d1.facecolor = [0.9 0.6 0.6];
Shoulder_d2.facecolor = [1.0 1.0 1.0];%Shoulder_d2.facecolor = [0.9 0.6 0.6];
leg_r1 = translate(scale(sph,L1/4, L1/5, L1/3),0,-0.9,0.15);
leg_r2 = translate(scale(sph,L1/4, L1/5, L1/3),0,0.9,0.15);
leg_r1.facecolor = [1.0 1.0 1.0];%leg_r1.facecolor = [0.9 0.6 0.6];
leg_r2.facecolor = [1.0 1.0 1.0];
