...
while (s22(1) > 0.0000001 && s22(1) < 19.99999995 && s22(2) > 0.0000001 && s22(2) < 19.9999995)
    ...
    if (rem(i,SampleData)==0)    
        ...
        CodeRec2(it2,:) = Code2';
        it2 = it2 + 1;
        if(XCoG2 <= 1.5 && YCoG2 >= 1.5)
            s22(3) = 90;
            [X2,Y2,XCoG2,YCoG2] = computecarpoints01(s22(1), s22(2), s22(3),'c',carL,carW,0);
            WalkCount2 = WalkCount2 + 1;
        elseif(XCoG2 <= 10 && YCoG2 <= 1.5)
            s22(3) = 180;
            [X2,Y2,XCoG2,YCoG2] = computecarpoints01(s22(1), s22(2), s22(3),'c',carL,carW,0);
            WalkCount2 = WalkCount2 + 1;
        elseif(XCoG2 >= 9.5 && YCoG2 >= 10)
            s22(3) = -90;
            [X2,Y2,XCoG2,YCoG2] = computecarpoints01(s22(1), s22(2), s22(3),'c',carL,carW,0);
            WalkCount2 = WalkCount2 + 1;
...
T2C2_Loc1 = Location1;T2C2_Loc2 = Location2;
T2C2_Dir1 = Direction1;T2C2_Dir2 = Direction2;
T2C2_Hist1 = Hist1;T2C2_Hist2 = Hist2;

clearvars -except T2C2_Loc1 T2C2_Loc2 T2C2_Dir1 T2C2_Dir2 T2C2_Hist1 T2C2_Hist2
