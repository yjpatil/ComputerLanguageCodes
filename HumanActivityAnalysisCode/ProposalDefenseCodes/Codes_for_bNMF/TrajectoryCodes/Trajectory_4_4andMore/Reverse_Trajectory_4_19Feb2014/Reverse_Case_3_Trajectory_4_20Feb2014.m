...
SampleData = 5; 
SamplePlot = 15; % <>----- "After how many iterations do you want to plot"
...
StopSign = 33;  % <>----- "Important:: How many times you want the Target to bump at the end and take reverse turn"

carL = 1.2;
carW = 1.3;

% % ----- Initial assignment of the position of the subject ----- % %
s11 = [1.5,18.5,0];%[X,Y,Angle w.r.t X]   % <>-------- Enter the Starting Point for 1st subject
computecarpoints(s11(1),s11(2),s11(3),'r',carL,carW);
hold on;
% % %
s22 = [19,1,180];%[X,Y,Angle w.r.t X]  % <>-------- Enter the Starting Point for 2nd subject
...
while (s11(1) > 0.0000001 && s11(1) < 19.99995 && s11(2) > 0.000001 && s11(2) < 19.9999995)
    ...
    if (rem(i,SampleData)==0) % Plot if 'ith' iteration and SamplePlt value have 1 e.g (rem(11,10) = 1)
        ...
        [X1,Y1,XCoG1,YCoG1] = computecarpoints01(s11(1), s11(2), s11(3),'r',carL,carW,0); % Compute the whole body component
        ...
        if(XCoG1 <= 10 && YCoG1 <= 7.5 ) % ......... (1) ......... %
            s11(3) = 125;%s11(3) = s11(3) - 270; % 270 = Turn Angle
            [X1,Y1,XCoG1,YCoG1] = computecarpoints01(s11(1), s11(2), s11(3),'r',carL,carW,0);
            WalkCount1 = WalkCount1 + 1;
        elseif(XCoG1 <= 2.0 && YCoG1 >= 17.5 ) % ......... (2) ......... %
            s11(3) = 0;%s11(3) = s11(3) - 270;
            [X1,Y1,XCoG1,YCoG1] = computecarpoints01(s11(1), s11(2), s11(3),'r',carL,carW,0);
            WalkCount1 = WalkCount1 + 1;
        elseif(XCoG1 >= 18.0 && YCoG1 >= 18.0 ) % ......... (2) ......... %
            s11(3) = 235;%s11(3) = s11(3) - 270;
            [X1,Y1,XCoG1,YCoG1] = computecarpoints01(s11(1), s11(2), s11(3),'r',carL,carW,0);
            WalkCount1 = WalkCount1 + 1;
...
while (s22(1) > 0.0000001 && s22(1) < 19.99999995 && s22(2) > 0.0000001 && s22(2) < 19.9999995)
    ...
    if (rem(i,SampleData)==0)           
        ...
        CodeRec2(it2,:) = Code2';
        it2 = it2 + 1;
        if(XCoG2 >= 10 && YCoG2 >= 12.5 )
            s22(3) = -55;
            [X2,Y2,XCoG2,YCoG2]=computecarpoints01(s22(1), s22(2), s22(3),'c',carL,carW,0);
            WalkCount2 = WalkCount2 + 1;
        elseif(XCoG2 >= 18.5 && YCoG2 <= 3.5 )
            s22(3) = 180;
            [X2,Y2,XCoG2,YCoG2]=computecarpoints01(s22(1), s22(2), s22(3),'c',carL,carW,0);
            WalkCount2 = WalkCount2 + 1;
        elseif(XCoG2 <= 2 && YCoG2 <= 3 )
            s22(3) = 55;
            [X2,Y2,XCoG2,YCoG2]=computecarpoints01(s22(1), s22(2), s22(3),'c',carL,carW,0);
            WalkCount2 = WalkCount2 + 1;
...
Rev_T4C3_Loc1 = Location1;Rev_T4C3_Loc2 = Location2;
Rev_T4C3_Dir1 = Direction1;Rev_T4C3_Dir2 = Direction2;
Rev_T4C3_Hist1 = Hist1;Rev_T4C3_Hist2 = Hist2;

clearvars -except Rev_T4C3_Loc1 Rev_T4C3_Loc2 Rev_T4C3_Dir1 Rev_T4C3_Dir2 Rev_T4C3_Hist1 Rev_T4C3_Hist2
