...
StopSign = 35;  % <>----- "Important:: How many times you want the Target to bump at the end and take reverse turn"
...
while (s11(1) > 0.0000001 && s11(1) < 19.99995 && s11(2) > 0.000001 && s11(2) < 19.9999995)
    ...
    if (rem(i,SampleData)==0) % Plot if 'ith' iteration and SamplePlt value have 1 e.g (rem(11,10) = 1)
        ...
        elseif(XCoG1 <= 1.0 && YCoG1 >= 18.5 ) % ......... (2) ......... %
            ...
            [X1,Y1,XCoG1,YCoG1] = computecarpoints01(s11(1), s11(2), s11(3),'r',carL,carW,0);
            WalkCount1 = WalkCount1 + 1;
        elseif(XCoG1 >= 18.5 && YCoG1 >= 18.5 ) % ......... (2) ......... %
...
T4C1_Loc1 = Location1;T4C1_Loc2 = Location2;
T4C1_Dir1 = Direction1;T4C1_Dir2 = Direction2;
T4C1_Hist1 = Hist1;T4C1_Hist2 = Hist2;

clearvars -except T4C1_Loc1 T4C1_Loc2 T4C1_Dir1 T4C1_Dir2 T4C1_Hist1 T4C1_Hist2
