...
s11 = [1.5,18.5,-90];%[X,Y,Angle w.r.t X]   % <>-------- Enter the Starting Point for 1st subject
computecarpoints(s11(1),s11(2),s11(3),'r',carL,carW);
hold on;
% % %
s22 = [19,1,90];%[X,Y,Angle w.r.t X]  % <>-------- Enter the Starting Point for 2nd subject
...
while (s11(1) > 0.0000001 && s11(1) < 19.99995 && s11(2) > 0.000001 && s11(2) < 19.9999995)
    ...
    if (rem(i,SampleData)==0) % Plot if 'ith' iteration and SamplePlt value have 1 e.g (rem(11,10) = 1)
        ...
        if(XCoG1 >= 13.0 && YCoG1 >= 10 ) % ......... (1) ......... %
            s11(3) = 145;%s11(3) = s11(3) - 270; % 270 = Turn Angle
            [X1,Y1,XCoG1,YCoG1] = computecarpoints01(s11(1), s11(2), s11(3),'r',carL,carW,0);
            WalkCount1 = WalkCount1 + 1;
        elseif(XCoG1 <= 2.0 && YCoG1 <= 1.5 ) % ......... (2) ......... %
            s11(3) = 35;%s11(3) = s11(3) - 270;
            [X1,Y1,XCoG1,YCoG1] = computecarpoints01(s11(1), s11(2), s11(3),'r',carL,carW,0);
            WalkCount1 = WalkCount1 + 1;
        elseif(XCoG1 <= 1.7 && YCoG1 >= 18.5 ) % ......... (2) ......... %
...
Rev_T4C4_Loc1 = Location1;Rev_T4C4_Loc2 = Location2;
Rev_T4C4_Dir1 = Direction1;Rev_T4C4_Dir2 = Direction2;
Rev_T4C4_Hist1 = Hist1;Rev_T4C4_Hist2 = Hist2;

clearvars -except Rev_T4C4_Loc1 Rev_T4C4_Loc2 Rev_T4C4_Dir1 Rev_T4C4_Dir2 Rev_T4C4_Hist1 Rev_T4C4_Hist2
