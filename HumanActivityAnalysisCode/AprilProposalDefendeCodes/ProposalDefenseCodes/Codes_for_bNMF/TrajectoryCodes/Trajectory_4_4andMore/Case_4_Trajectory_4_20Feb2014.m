...
s11 = [1.5,18.5,-35];%[X,Y,Angle w.r.t X]   % <>-------- Enter the Starting Point for 1st subject
computecarpoints(s11(1),s11(2),s11(3),'r',carL,carW);
hold on;
% % %
s22 = [19,1,145];%[X,Y,Angle w.r.t X]  % <>-------- Enter the Starting Point for 2nd subject
...
while (s11(1) > 0.0000001 && s11(1) < 19.99995 && s11(2) > 0.000001 && s11(2) < 19.9999995)
    ...
    if (rem(i,SampleData)==0) % Plot if 'ith' iteration and SamplePlt value have 1 e.g (rem(11,10) = 1)
        ...
        if(XCoG1 >= 12.5 && YCoG1 <= 10 ) % ......... (1) ......... %
            s11(3) = 215;%s11(3) = s11(3) - 270; % 270 = Turn Angle
            [X1,Y1,XCoG1,YCoG1] = computecarpoints01(s11(1), s11(2), s11(3),'r',carL,carW,0);
            WalkCount1 = WalkCount1 + 1;
        elseif(XCoG1 <= 2.0 && YCoG1 <= 2.0 ) % ......... (2) ......... %
            s11(3) = 90;%s11(3) = s11(3) - 270;
            [X1,Y1,XCoG1,YCoG1] = computecarpoints01(s11(1), s11(2), s11(3),'r',carL,carW,0);
            WalkCount1 = WalkCount1 + 1;
        elseif(XCoG1 <= 3.5 && YCoG1 >= 18.5 ) % ......... (2) ......... %
            s11(3) = -35;%s11(3) = s11(3) - 270;
            [X1,Y1,XCoG1,YCoG1] = computecarpoints01(s11(1), s11(2), s11(3),'r',carL,carW,0);
            WalkCount1 = WalkCount1 + 1;
...
while (s22(1) > 0.0000001 && s22(1) < 19.99999995 && s22(2) > 0.0000001 && s22(2) < 19.9999995)
    ...
    if (rem(i,SampleData)==0)           
        ...
        CodeRec2(it2,:) = Code2';
        it2 = it2 + 1;
        if(XCoG2 <= 7.5 && YCoG2 >= 10 )
            s22(3) = 35;
            [X2,Y2,XCoG2,YCoG2]=computecarpoints01(s22(1), s22(2), s22(3),'c',carL,carW,0);
            WalkCount2 = WalkCount2 + 1;
        elseif(XCoG2 >= 18.0 && YCoG2 >= 18.0 )
            s22(3) = -90;
            [X2,Y2,XCoG2,YCoG2]=computecarpoints01(s22(1), s22(2), s22(3),'c',carL,carW,0);
            WalkCount2 = WalkCount2 + 1;
        elseif(XCoG2 <= 19.5 && YCoG2 <= 1.5 )
            s22(3) = 145;
            [X2,Y2,XCoG2,YCoG2]=computecarpoints01(s22(1), s22(2), s22(3),'c',carL,carW,0);
            WalkCount2 = WalkCount2 + 1;
...
T4C4_Loc1 = Location1;T4C4_Loc2 = Location2;
T4C4_Dir1 = Direction1;T4C4_Dir2 = Direction2;
T4C4_Hist1 = Hist1;T4C4_Hist2 = Hist2;

clearvars -except T4C4_Loc1 T4C4_Loc2 T4C4_Dir1 T4C4_Dir2 T4C4_Hist1 T4C4_Hist2
