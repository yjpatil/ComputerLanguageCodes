...
hold on;
% % %
s22 = [19,1,135];%[X,Y,Angle w.r.t X]  % <>-------- Enter the Starting Point for 2nd subject
...
while (s11(1) > 0.0000001 && s11(1) < 19.99995 && s11(2) > 0.000001 && s11(2) < 19.9999995)
    ...
    if (rem(i,SampleData)==0) % Plot if 'ith' iteration and SamplePlt value have 1 e.g (rem(11,10) = 1)
        ...
        if(XCoG1 >= 10 && YCoG1 <= 11 ) % ......... (1) ......... %
            s11(3) = 225;%s11(3) = s11(3) - 270; % 270 = Turn Angle
            [X1,Y1,XCoG1,YCoG1] = computecarpoints01(s11(1), s11(2), s11(3),'r',carL,carW,0);
            WalkCount1 = WalkCount1 + 1;
        elseif(XCoG1 <= 1.5 && YCoG1 <= 1.5 ) % ......... (2) ......... %
            s11(3) = 90;%s11(3) = s11(3) - 270;
            [X1,Y1,XCoG1,YCoG1] = computecarpoints01(s11(1), s11(2), s11(3),'r',carL,carW,0);
            WalkCount1 = WalkCount1 + 1;
        elseif(XCoG1 <= 4.5 && YCoG1 >= 18.5 ) % ......... (2) ......... %
...
T4C2_Loc1 = Location1;T4C2_Loc2 = Location2;
T4C2_Dir1 = Direction1;T4C2_Dir2 = Direction2;
T4C2_Hist1 = Hist1;T4C2_Hist2 = Hist2;

clearvars -except T4C2_Loc1 T4C2_Loc2 T4C2_Dir1 T4C2_Dir2 T4C2_Hist1 T4C2_Hist2
