...
X1orig = Data6; % ---(1) Medium-Small 1's --- %
X2orig = Data5; % ---(2) Largest 1's --- %
X3orig = Data1; % ---(3) Very Small 1's --- %
X4orig = Data4; % ---(4) Medium-Large 1's --- %
X5orig = Data7; % ---(5) Medium 1's --- %

X6orig = Data2; % ---(6) Small-Medium 1's --- %
X7orig = Data3; % ---(7) Larger 1's --- %
...
PerbRate = 15; % <>-------- Perturbation Rate % of bits flipping <>||
NoPerbRate = 0;

[X1] = fperturb01(X1orig,NoPerbRate);
[X2] = fperturb01(X2orig,NoPerbRate);
[X3] = fperturb01(X3orig,NoPerbRate);
[X4] = fperturb01(X4orig,PerbRate);
[X5] = fperturb01(X5orig,PerbRate);

[X6] = fperturb01(X6orig,NoPerbRate);
[X7] = fperturb01(X7orig,NoPerbRate);
...
% <>----------- Case (1) ---------<> %
X = [X5;X4];%;X5];%;X1];  % <>-------<<< Which Sources are present *** <Sometimes you have to change the order of X's so as to achieve a perticular results> *** 
Sources00 = [StatsData5(1);StatsData4(1);StatsData1(1)];%StatsData5(1)];%StatsData4(1)];
Sources01 = [StatsData5(2);StatsData4(2);StatsData1(2)];%StatsData5(2)];%StatsData4(2)];
Sources10 = [StatsData5(3);StatsData4(3);StatsData1(3)];%StatsData5(3)];%StatsData4(3)];
Sources11 = [StatsData5(4);StatsData4(4);StatsData1(4)];%StatsData5(4)];%StatsData4(4)];
% <> ----------------- <> ------------------ <> %
% <>----------- Case (2) ---------<> %
% X = [X2;X3;X4;X5];%X1];  % <>-------<<< Which Sources are present *** <Sometimes you have to change the order of X's so as to achieve a perticular results> *** 
% Sources00 = [StatsData2(1);StatsData3(1);StatsData4(1);StatsData5(1)];%StatsData1(1)];
% Sources01 = [StatsData2(2);StatsData3(2);StatsData4(2);StatsData5(2)];%StatsData1(2)];
% Sources10 = [StatsData2(3);StatsData3(3);StatsData4(3);StatsData5(3)];%StatsData1(3)];
% Sources11 = [StatsData2(4);StatsData3(4);StatsData4(4);StatsData5(4)];%StatsData1(4)];
% <> ----- <> 
% X = [X1;X2;X3];  % <>------------------ Which Sources are present <>
% Sources00 = [StatsData1(1);StatsData2(1);StatsData3(1)];
...
% Sources00 = [StatsData2(1);StatsData4(1);StatsData1(1);StatsData4(1)];
% Sources01 = [StatsData2(2);StatsData4(2);StatsData1(2);StatsData4(2)];
% Sources10 = [StatsData2(3);StatsData4(3);StatsData1(3);StatsData4(3)];
% Sources11 = [StatsData2(4);StatsData4(4);StatsData1(4);StatsData4(4)];
...
% <> ----------------- <> ------------------ <> %
% X = [X5;X3;X4;X2;X1];  % <>-------<<< Which Sources are present *** <Sometimes you have to change the order of X's so as to achieve a perticular results> *** 
% Sources00 = [StatsData5(1);StatsData3(1);StatsData4(1);StatsData2(1);StatsData1(1)];
% Sources01 = [StatsData5(2);StatsData3(2);StatsData4(2);StatsData2(2);StatsData1(2)];
% Sources10 = [StatsData5(3);StatsData3(3);StatsData4(3);StatsData2(3);StatsData1(3)];
% Sources11 = [StatsData5(4);StatsData3(4);StatsData4(4);StatsData2(4);StatsData1(4)];
% <> ----------------- <> ------------------ <> %


% <> ----------------- <> ------------------ <> %
% X = [X1;X2;X4;X5];%;X1];  % <>-------<<< Which Sources are present *** <Sometimes you have to change the order of X's so as to achieve a perticular results> *** 
% Sources00 = [StatsData1(1);StatsData2(1);StatsData4(1);StatsData5(1);StatsData3(1)];
% Sources01 = [StatsData1(2);StatsData2(2);StatsData4(2);StatsData5(2);StatsData3(2)];
% Sources10 = [StatsData1(3);StatsData2(3);StatsData4(3);StatsData5(3);StatsData3(3)];
% Sources11 = [StatsData1(4);StatsData2(4);StatsData4(4);StatsData5(4);StatsData3(4)];
% <> ----------------- <> ------------------ <> %
p = [];
verbose = 0;
...
Nmix = 20;   % Number of randomly generated mixing e.g. 15 Mixing Coeff
% min1 = 0.01;max1 = 0.99;
% diff = max1 - min1;
% m1 = diff/Nmix;
% o1 = ones(Nmix,1);
...
for i = 1 : 1 : iter          
    ...
    for inner=1:inner_iter
        ...
        [l,ind,lik] = fBound_Revised_Markov(l,gamma0,S,elogW00,elogW01,elogW10,elogW11,...
                       elog1W00,elog1W01,elog1W10,elog1W11,Delta00,Delta01,Delta10,Delta11,elogS,x,verbose,'bo',ind);
