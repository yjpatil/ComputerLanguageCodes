...
figure(4);hold on;title('Latent = 4,LogLikelihood for Different Scenarios');xlabel('iterations');ylabel('Log-likelihood')
figure(5);hold on;title('Latent = 5,LogLikelihood for Different Scenarios');xlabel('iterations');ylabel('Log-likelihood')
figure(6);hold on;title('Latent = 6,LogLikelihood for Different Scenarios');xlabel('iterations');ylabel('Log-likelihood')
figure(7);hold on;title('Latent = 7,LogLikelihood for Different Scenarios');xlabel('iterations');ylabel('Log-likelihood')
figure(8);hold on;title('Latent = 8,LogLikelihood for Different Scenarios');xlabel('iterations');ylabel('Log-likelihood')
...
printmat(R1_TrLL, 'LogLikVsScs', 'Basis_V1 Basis_V2 Basis_V3 Basis_V4 Basis_V5 Basis_V6 Basis_V7', 'Scenario1 Scenario2 Scenario3 Scenario4' )
