...
printmat(R1_TrLL, 'LogLikVsScs', 'Basis_V1 Basis_V2 Basis_V3 Basis_V4 Basis_V5 Basis_V6 Basis_V7 Basis_V8 Basis_V9', 'Scenario1 Scenario2 Scenario3 Scenario4' )
...
% % % % Outputs = [R1_TrLL(1,:)';R1_TrLL(2,:)';R1_TrLL(3,:)']
% % % % 
% % % % Targets = [1;0;0;0;1;0;0;0;1];
% % % % 
% % % % rocData = [Outputs,Targets] 
% % % % 
% % % % figure(231)
% % % % ROCout = roc(rocData,[],0.05,1)
