...
%     plot(Score(:,3),zpl1,'hk',Score(:,4),zpl2,'hk');grid on; hold on;
    ...
    while(H <= length(SEtsPS))
        ...
        subj(I).Features(H,4) = S(I).h(hamp(ha),4);
        ...
        subj(I).Features(H,14) = S(I).h(hamp(ha),14);
        ...
        if(err6 == 0) %% the "end" and "else" for this "if" is in FFE_EXT_Part2
            ...
            subj(I).Features(H,6) = S(I).h(hamp(ha),6);
            ...
            if(err5 == 0) 
                ...
                subj(I).Features(H,5) = S(I).h(hamp(ha),5);
            ...
            if(err11 == 0)
                ...
                subj(I).Features(H,11) = S(I).h(hamp(ha),11);
            ...
            if(err13 == 0)
                ...
                subj(I).Features(H,13) = S(I).h(hamp(ha),13);
            ...
            if(err12 == 0)
                ...
                subj(I).Features(H,12) = S(I).h(hamp(ha),12);
            ...
            if(err9a == 0)
                ...
                if(err9b == 0)
                    ...
                    subj(I).Features(H,9) = S(I).h(hamp(ha),9);
            ...
            if(err10 == 0)
                ...
                subj(I).Features(H,10) = S(I).h(hamp(ha),10);
            ...
            subj(I).Features(H,2) = S(I).h(hamp(ha),2);
            ...
            subj(I).Features(H,8) = S(I).h(hamp(ha),8);
            ...
            if(err3 == 0)
                ...
                subj(I).Features(H,3) = S(I).h(hamp(ha),3);
            ...
            if(err3 == 0 && err9b == 0)
                ...
                subj(I).Features(H,7) = S(I).h(hamp(ha),7);
            ...
            if(err1a == 0)
                ...
                if(err1b == 0)
                    ...
                    subj(I).Features(H,1) = S(I).h(hamp(ha),1);
        ...
        SS(I).Labels(H,1) = -1; %<==================== Label Assignment %%
