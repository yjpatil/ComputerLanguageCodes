...
for I = 1 : 1 : N
    clear('S1','S2');
    S1 = cat(2,Subject(I).Features(:,2),Subject(I).Features(:,3),Subject(I).Features(:,4),Subject(I).Features(:,5),Subject(I).Features(:,6),Subject(I).Features(:,10),Subject(I).Features(:,11),Subject(I).Features(:,13),Subject(I).Features(:,14)); % Subject # I Features
    lS1 = size(S1,2);
    ...
    for J = 1 : 1 : 10
        ...
        PTrain_F = SP(hRp1,lS1);     % "PTrain_F" contains FEATURES for +1 Labels 
        PTrain_L = SP(hRp1,lS1+1);       % "PTrain_L" contains LABELS for +1 Labels
        clear('NTrain_F','NTrain_L');
        NTrain_F = SN(hRn1,lS1);     % "NTrain_F" contains FEATURES for -1 Labels 
        NTrain_L = SN(hRn1,lS1+1);       % "NTrain_L" contains LABELS for -1 Labels 
        ...
        PTest_F = SP(hRp2,lS1);      % "PTrain_F" contains FEATURES for +1 Labels 
        PTest_L = SP(hRp2,lS1+1);        % "PTest_L" contains LABELS for +1 Labels 
        clear('NTest_F','NTest_L');
        NTest_F = SN(hRn2,lS1);      % "NTest_F" contains FEATURES for -1 Labels 
        NTest_L = SN(hRn2,lS1+1);        % "NTest_L" contains LABELS for -1 Labels 
