...
Index = find(Lab2_T1 <= ts & ts <= Lab2_T2);
PS_Index = find(Lab2_T1 <= puff_score(:,2) & puff_score(:,2) <= Lab2_T2);
...
figure;hold on;grid on;title(strcat('Second Lab Session Data for Subject',' ',list(I,11:13),' (2 cigarettes)'));xlabel('Time \it s');ylabel('Air Flow, Tidal Vol, Hand Proximity Signal')        
