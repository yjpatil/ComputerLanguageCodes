...
plot([Lab_sessions(1,1) Lab_sessions(1,1)],[-5 5],'color','k','Linewidth',2);
plot([Lab_sessions(1,3) Lab_sessions(1,3)],[-5 5],'color','r','Linewidth',2);
plot([Lab_sessions(1,2) Lab_sessions(1,2)],[-5 5],'color','r','Linewidth',2);

plot([Lab_sessions(2,1) Lab_sessions(2,1)],[-5 5],'color','k','Linewidth',2);
plot([Lab_sessions(2,3) Lab_sessions(2,3)],[-5 5],'color','r','Linewidth',2);
...
legend([Hraw H1 H2 H3(1) H4(1)],{'Raw ProxSen' 'Air Flow' 'Tidal Volume' 'Start of Puff' 'End of Puff'});  
