...
% %         end
        ...
        %figure;hold on;
        [CodeAS] = EncodedSeq(ASts_temp,45); % The first argument is (1)Signal (AirFlow or TidalVolume), (2)Interval between succesive data points
        ...
        %figure;hold on;
        [CodeVT] = EncodedSeq(VTts_temp,25); % The first argument is (1)Signal (AirFlow or TidalVolume), (2)Interval between succesive data points
        % You can also form two separate sit and stand smk cells, by simply
        % comparing the ASpeak time that occur before the start of stand
        % smk event
        if(Label == +1)
