function[Data1,Data2,Data3,Data4,Data5,Data6,Data7,StatsData1,StatsData2,StatsData3,StatsData4,StatsData5,StatsData6,StatsData7] = fCreate_4Sub_MarkovPData(N,MaxSensors)
...
for I = 1 : 1 : MaxSensors
    gcf;
    H11 = plot3(StatsData1(I,1),StatsData1(I,2),StatsData1(I,3),'kx','Linewidth',2.0);
    hold on;grid on;
end
...
for I = 1 : 1 : MaxSensors
    gcf;
    H44 = plot3(StatsData4(I,1),StatsData4(I,2),StatsData4(I,3),'kp','Linewidth',2.0);
    hold on;grid on;
end
xlabel('P00');ylabel('P01');zlabel('P10');%title(strcat('Statistics for ',num2str(D),'sensors'))
xlim([0 1]);ylim([0 1]);zlim([0 1])
...
for I = 1 : 1 : MaxSensors
    gcf;
    H55 = plot3(StatsData5(I,1),StatsData5(I,2),StatsData5(I,3),'kh','Linewidth',2.0);
    hold on;grid on;
end
xlabel('P00');ylabel('P01');zlabel('P10');%title(strcat('Statistics for ',num2str(D),'sensors'))
xlim([0 1]);ylim([0 1]);zlim([0 1])
...
for I = 1 : 1 : MaxSensors
    gcf;
    H66 = plot3(StatsData6(I,1),StatsData6(I,2),StatsData6(I,3),'ks','Linewidth',2.0);
    hold on;grid on;
end
xlabel('P00');ylabel('P01');zlabel('P10');%title(strcat('Statistics for ',num2str(D),'sensors'))
xlim([0 1]);ylim([0 1]);zlim([0 1])
...
%legend([H11 H22 H33 H44 H55 H66 H77],{'Target 1' 'Target 2' 'Target 3' 'Target 4' 'Target 5' 'Target 6' 'Target 7'});

%legend([H66 H55 H11 H44 H77],{'Target 1' 'Target 2' 'Target 3' 'Target 4' 'Target 5'});

legend([H66 H55 H11 H44 ],{'Target 1' 'Target 2' 'Target 3' 'Target 4'});
end
