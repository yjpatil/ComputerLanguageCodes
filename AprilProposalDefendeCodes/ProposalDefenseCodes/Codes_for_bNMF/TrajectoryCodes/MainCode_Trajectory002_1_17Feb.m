...
StopSign = 4;  % <>----- "Important:: How many times you want the Target to bump at the end and take reverse turn"
...
hold on;
s22 = [2.5,16.5,0];%[17.0,16,-90];%[X,Y,Angle w.r.t X]  % <>-------- Enter the Starting Point for 2nd subject
...
% % title('Histogram of Location for Activity02','FontSize',13.0);xlabel('Locations','FontSize',13.0);
% % 
% % figure(2);hold on;
% % subplot(2,1,2);hist(Location2,xvalues);
% % H22 = findobj(gca,'Type','patch');set(H22,'FaceColor','w','EdgeColor','k')
% % xlabel('Locations','FontSize',13.0);%title('Histogram for Location');
