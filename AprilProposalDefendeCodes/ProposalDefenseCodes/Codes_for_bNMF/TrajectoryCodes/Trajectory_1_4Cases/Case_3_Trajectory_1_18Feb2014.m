...
s11 = [12.5,18,-90];%[X,Y,Angle w.r.t X]   % <>-------- Enter the Starting Point for 1st subject
computecarpoints(s11(1),s11(2),s11(3),'r',carL,carW);
hold on;
s22 = [18,7.5,180];%[X,Y,Angle w.r.t X]  % <>-------- Enter the Starting Point for 2nd subject
...
T1C3_Loc1 = Location1;T1C3_Loc2 = Location2;
T1C3_Dir1 = Direction1;T1C3_Dir2 = Direction2;
T1C3_Hist1 = Hist1;T1C3_Hist2 = Hist2;

clearvars -except T1C3_Loc1 T1C3_Loc2 T1C3_Dir1 T1C3_Dir2 T1C3_Hist1 T1C3_Hist2
