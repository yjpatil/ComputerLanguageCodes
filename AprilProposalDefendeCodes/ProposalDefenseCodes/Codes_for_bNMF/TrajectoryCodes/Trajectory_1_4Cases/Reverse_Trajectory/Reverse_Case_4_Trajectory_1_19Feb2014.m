...
s11 = [17.5,1.5,90];%[X,Y,Angle w.r.t X]   % <>-------- Enter the Starting Point for 1st subject
computecarpoints(s11(1),s11(2),s11(3),'r',carL,carW);
hold on;
s22 = [1.5,1.5,0];%[X,Y,Angle w.r.t X]  % <>-------- Enter the Starting Point for 2nd subject
...
Rev_T1C4_Loc1 = Location1;Rev_T1C4_Loc2 = Location2;
Rev_T1C4_Dir1 = Direction1;Rev_T1C4_Dir2 = Direction2;
Rev_T1C4_Hist1 = Hist1;Rev_T1C4_Hist2 = Hist2;

clearvars -except Rev_T1C4_Loc1 Rev_T1C4_Loc2 Rev_T1C4_Dir1 Rev_T1C4_Dir2 Rev_T1C4_Hist1 Rev_T1C4_Hist2
