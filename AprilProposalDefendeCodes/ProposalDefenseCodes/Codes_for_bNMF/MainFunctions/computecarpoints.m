function [x_points,y_points,XCoG,YCoG] = computecarpoints(x0,y0,angle,Color,carL,carW)
gcf;
...
plot([XCoG Xm2m3],[YCoG Ym2m3], 'Color',Color,'Linewidth',1.5); % % **This is the part where you plot the nose/front end of the 
