...
save('C:\Users\student\Documents\MATLAB\Segmentation_of_Waveform\June52013\ASts_Sub007Read','ASts_SubXX')
Ind_VT = find( T3.Position(1,1)<= VTts(:,1) & VTts(:,1) <= T4.Position(1,1));
VTts_SubXX = VTts(Ind_VT,:);

save('C:\Users\student\Documents\MATLAB\Segmentation_of_Waveform\June52013\VTts_Sub007Read','VTts_SubXX')

% % Ind_PS = find( T1.Position(1,1)<= Score(:,3) & Score(:,4) <= T2.Position(1,1));
% % Puff_Score = Score(Ind_PS,:);
% % 
% % 
% % 
% % Err1 = isempty(Ind_PS);
