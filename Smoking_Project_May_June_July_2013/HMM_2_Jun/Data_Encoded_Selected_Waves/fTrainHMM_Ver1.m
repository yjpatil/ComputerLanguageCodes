function[BestLogLkhd,BestHmm,BestStates,BestObs,BestIter,RecLogLkhd] = fTrainHMM_Ver1(StartState,EndState,StartObs,EndObs,MaxIter,Data)
...
BestStates = 0;BestObs = 0;BestIter = [];BestHmm = [];BestLogLkhd = -50000000;
