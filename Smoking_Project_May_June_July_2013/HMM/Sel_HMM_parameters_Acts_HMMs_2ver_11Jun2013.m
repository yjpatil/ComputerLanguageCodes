...
%while(I <= Size_List)
    ...
    Actcnt = 1; % Activity #      %  <<----------- MAKE CHANGES HERE $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
...
%     plot(TableOA(:,6))
    ...
    % $$$$$$$$$$$$$$$$$$$$$$$$$ MAKE CHANGES HERE $$$$$$$$$$$$$$$$$$$$$$$ %
    save('C:\Users\student\Documents\MATLAB\Smoking_Project_May_June_2013\BestHMM\Subject_021\Activities_01\BestHMM_Act1','BestHMM')  %  <<----------- MAKE CHANGES HERE $$$$$$$$$$
